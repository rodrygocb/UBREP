...
<body>
  ...
  <nav class="navbar navbar-expand-md navbar-dark fixed-top bg-dark">
    <div class="container-fluid">
          <img src="img/img.png" height="50" width="200"> &nbsp;&nbsp;&nbsp;&nbsp;
      ...
      <div class="collapse navbar-collapse" id="navbarCollapse">
        ...
        <form class="d-flex" role="search" action="pesquisar_livro.php" method="GET">
  ...
  <body>
    ...
    <div class="detalhes">
        ...
        // Verifica se o parâmetro ISBN está presente na URL
        if (isset($_GET['isbn'])) {
            $isbn = $_GET['isbn'];

            // Consulta o banco de dados para obter os detalhes do livro
            ...
            echo "<p>ISBN não especificado.</p>";
        }
...
<br><br><br><br><br>
  ...
  <footer class="container">
    ...
    <p>&copy; 2023 Company, Inc. &middot; <a href="#">Privacidade</a> &middot; <a href="#">Termos</a></p>
  </footer>
